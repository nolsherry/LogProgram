...
public class LogFileWriter {
	...
	//THE FUNCTION HAS SOMETHING WRONG, I SHOULD CHECK IT
	public void writeReadMeFile() throws IOException{
		
		if(SystemParameters.totalSecond > 0){
			
			int AccRate = SystemParameters.AccCount/SystemParameters.totalSecond;
			int MagRate = SystemParameters.MagCount/SystemParameters.totalSecond;			
			...
			String outputString = 
					...
					+"Data Collector: "+SystemParameters.Collector	+"\r\n"

    ...
    private void initDrawerList(){
        ...
        lstDrawer.setOnItemClickListener(new OnItemClickListener(){ 
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				{
					case 0:
	    				Intent CtransIntent = new Intent(getApplication(), E_Setting.class);
					...
					case 1: 
						...
						break;
					case 2: 
						startActivity(new Intent(getApplicationContext(), E_ProgramDescription.class)); 	  
						break;
					case 3:
						//login account resignation page
						startActivity(new Intent(getApplicationContext(), E_Resignation.class));
						break;
					case 4:
						startActivity(new Intent(getApplicationContext(), BumpRecord.class));
						break;
					default:
						break;
				}				

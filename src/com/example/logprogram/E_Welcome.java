...
public class E_Welcome extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        viewList.add(Inflater.inflate(R.layout.e_welcome1,null));
        viewList.add(Inflater.inflate(R.layout.e_welcome2,null)); 
	...
	public void skipButton(){
	    ...
	    public void onClick(View v) {
		    ...
		    intent.setClass(E_Welcome.this,NetworkChecking.class);
		    startService(intent);
		    //Log.d("imgbutton", "depart");
		    doBindService();
	    }	

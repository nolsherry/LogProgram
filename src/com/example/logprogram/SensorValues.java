...
public class SensorValues {
	...
	public SensorValues(double xValue, double yValue, double zValue) {
		...
		this.yValue = yValue;
		this.zValue = zValue;
		this.norm = Math.sqrt(this.xValue*this.xValue+this.yValue*this.yValue+this.zValue*this.zValue);
	}
	...
	public static SensorValues standardDeviation(ArrayList<SensorValues> vectors) {
		...
		vX = Math.sqrt(xX/vectors.size() - (vX/vectors.size())*(vX/vectors.size()));
		vY = Math.sqrt(yY/vectors.size() - (vY/vectors.size())*(vY/vectors.size()));
		vZ = Math.sqrt(zZ/vectors.size() - (vZ/vectors.size())*(vZ/vectors.size()));
